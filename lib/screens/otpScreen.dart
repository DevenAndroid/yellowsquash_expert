          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.poppins(color: const Color(0xff2D2D2D), fontSize: 16, fontWeight: FontWeight.w500),
              ),
              Text(
                'qnicole@markhansongu.com',
                style: GoogleFonts.poppins(color: const Color(0xff2D2D2D), fontSize: 14, fontWeight: FontWeight.w500),
              ),
